...
int_t _EWL_CDECL wprintf(const wchar_t * _EWL_RESTRICT format, ...)
{
	...
	#else
		result = __wpformatter(__wFileWrite, (void *)stdout, format, __va_start(format), 0);
...
int_t _EWL_CDECL wprintf_s(const wchar_t * _EWL_RESTRICT format, ...)
{
	...
	#else
		result = __wpformatter(__wFileWrite, (void *)stdout, format, __va_start(format), 1);
	#endif	/* __PPC_EABI__ || __MIPS__  */
...
#else
	result = __wpformatter(__wFileWrite, (void *)file, format, __va_start(format), 0);
#endif	/* __PPC_EABI__ || __MIPS__ */
...
#else
	result = __wpformatter(__wFileWrite, (void *)file, format, __va_start(format), 1);
#endif	/* __PPC_EABI__ || __MIPS__ */
...
MISRA_EXCEPTION_RULE_16_1()
int_t _EWL_CDECL snwprintf_s(wchar_t * _EWL_RESTRICT s, rsize_t n, const wchar_t * _EWL_RESTRICT format, ...)
{
#if (defined(__PPC_EABI__)    || defined(__MIPS__))
	va_list args;
	va_start( args, format );
	return(vsnwprintf_s(s, n, format, args));
#else
