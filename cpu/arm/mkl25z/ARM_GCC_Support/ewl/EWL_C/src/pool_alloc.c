 ...
 *
 *  The macro _EWL_POOL_ALIGNMENT may be defined to allow modifying
 *  the alignment without editing this file. The alignment must still
 *  be a multiple of 4, e.g.
 *  #define _EWL_POOL_ALIGNMENT 4L
 */

#ifndef _EWL_POOL_ALIGNMENT
	#if (defined(__POWERPC__) || defined(__INTEL__) || defined(__MIPS__))
	
		#define _EWL_POOL_ALIGNMENT 8L		/* 8-byte alignment */
	#else
	
		#define _EWL_POOL_ALIGNMENT 4L		/* 4-byte alignment */
	#endif
#endif /* _EWL_POOL_ALIGNMENT */

#define alignment (_EWL_POOL_ALIGNMENT - 1L)
...
void _EWL_CDECL __init_align_pool_obj(mem_pool_obj * pool_obj, char block_alignment)
{
...
int _EWL_CDECL __pool_preallocate(mem_pool_obj * pool_obj, mem_size size )
{
#if _EWL_OS_ALLOC_HEAP_SUPPORT
...
void _EWL_CDECL __pool_preassign(mem_pool_obj * pool_obj, void * ptr, mem_size size)
{
...
#endif /* !defined(_EWL_CLASSIC_MALLOC) */
