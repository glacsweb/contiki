...
#if !_EWL_LONGLONG
#if (_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_IO)
#warning "Impossible to perform long long IO when long long support is not available!"
#endif
#undef _EWL_LONGLONG_IO
#define _EWL_LONGLONG_IO	0
#endif
...
enum argument_options
{
    ...
    ,
    long_long_argument
#endif /*_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_IO */
...
#endif /* _EWL_C99_PRINTF_SCANF && _EWL_FLOATING_POINT_IO */
...
#if _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_IO)
...
#endif /* _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_IO) */
