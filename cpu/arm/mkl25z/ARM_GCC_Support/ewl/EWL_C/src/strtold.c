...
#ifndef _EWL_STRTOLD_FOR_COMPILER
#define _EWL_STRTOLD_FOR_COMPILER	0	/* use "1" to use this file in the CW FE */
#endif

#if !_EWL_STRTOLD_FOR_COMPILER
...
#endif /* !_EWL_STRTOLD_FOR_COMPILER */
