...
/* $Id: fmod_StarCore.c,v 1.2 2011/01/20 16:45:17 b20982 Exp $ */
/*
 * ====================================================
...
/*
 * fmod(x,y) - same as __ieee754_fmod(x,y)
...
MISRA_QUIET_LINT_03()
static f64_t one = 1.0F, Zero[] = {0.0F, -0.0F,};
