...
#if !_EWL_USES_SUN_MATH_LIB && _EWL_USES_SUN_SP_MATH_LIB
#error "Macro _EWL_USES_SUN_SP_MATH_LIB requires _EWL_USES_SUN_MATH_LIB be true!"
#endif

#ifndef _EWL_ONLY_SINGLE_PRECISION_MATH_LIB
		/* 1: All double and long double math routines will use single precision routines.	*/
#define _EWL_ONLY_SINGLE_PRECISION_MATH_LIB 0
#endif

#if _EWL_ONLY_SINGLE_PRECISION_MATH_LIB
	#if !_EWL_USES_SUN_SP_MATH_LIB
		#error "Macro _EWL_ONLY_SINGLE_PRECISION_MATH_LIB requires _EWL_USES_SUN_SP_MATH_LIB be true!"
	#elif _EWL_USES_SUN_DP_MATH_LIB
		#error "Macro _EWL_ONLY_SINGLE_PRECISION_MATH_LIB requires _EWL_USES_SUN_DP_MATH_LIB be false!"
	#endif
#endif
...
#ifndef _EWL_USING_MW_C_HEADERS
#define _EWL_USING_MW_C_HEADERS 	1
#endif
...
#define _EWL_DO_NOT_INLINE 			__declspec(weak)
#endif
...
#if !defined(_EWL_USE_INLINE) && defined(__CWCC__)
