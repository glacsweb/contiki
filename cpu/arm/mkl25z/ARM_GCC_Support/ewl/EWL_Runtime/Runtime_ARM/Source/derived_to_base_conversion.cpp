...
const unsigned char SI_CLASS_TYPEINFO_VTNAME[];
const unsigned char VMI_CLASS_TYPEINFO_VTNAME[];
inline bool ClassRTTIVTablePointerCompare(const void *,const void *);
}
