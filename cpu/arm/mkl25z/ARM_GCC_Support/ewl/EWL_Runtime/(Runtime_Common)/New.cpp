...
#pragma overload extern void * _EWL_CDECL operator new(_CSTD::size_t) throw(_STD::bad_alloc);
#pragma overload extern void * _EWL_CDECL operator new(_CSTD::size_t,const _STD::nothrow_t&) throw();
#pragma overload extern void _EWL_CDECL operator delete(void *) throw();
...
#pragma overload extern void _EWL_CDECL operator delete  (void *, const _STD::nothrow_t&) _EWL_NO_THROW;
#pragma overload extern void _EWL_CDECL operator delete[](void *, const _STD::nothrow_t&) _EWL_NO_THROW;
#endif
...
/*	Return...:	pointer to memory or 0L									*/
/************************************************************************/
_EWL_IMP_EXP_RUNTIME void * _EWL_CDECL OPERATOR_NEW(_CSTD::size_t size) throw(_STD::bad_alloc)
{
	void *ptr;
...
/*	Return...:	pointer to memory or 0L									*/
/************************************************************************/
_EWL_IMP_EXP_RUNTIME void * _EWL_CDECL OPERATOR_NEW(_CSTD::size_t size, const _STD::nothrow_t&) throw()
{
	try
	{
...
/*	Return...:	---														*/
/************************************************************************/
_EWL_IMP_EXP_RUNTIME void _EWL_CDECL OPERATOR_DELETE(void *ptr) throw()
{
...
/************************************************************************/
#if __MWERKS__>=0x2020
_EWL_IMP_EXP_RUNTIME extern void * _EWL_CDECL OPERATOR_ARRAY_NEW(_CSTD::size_t size) throw(_STD::bad_alloc)
{
	return OPERATOR_NEW(size);
}
_EWL_IMP_EXP_RUNTIME extern void * _EWL_CDECL OPERATOR_ARRAY_NEW(_CSTD::size_t size,const _STD::nothrow_t& nt) throw()
{
	return OPERATOR_NEW(size,nt);
}
_EWL_IMP_EXP_RUNTIME extern void _EWL_CDECL OPERATOR_ARRAY_DELETE(void *ptr) throw()
{
	OPERATOR_DELETE(ptr);
}
#endif
...
#if __MWERKS__ >= 0x2400
_EWL_IMP_EXP_RUNTIME extern __declspec(weak) void _EWL_CDECL OPERATOR_DELETE(void* ptr,const _STD::nothrow_t&) _EWL_NO_THROW
{
    OPERATOR_DELETE(ptr);
}
_EWL_IMP_EXP_RUNTIME extern __declspec(weak) void _EWL_CDECL OPERATOR_ARRAY_DELETE(void* ptr, const _STD::nothrow_t&) _EWL_NO_THROW
{
    OPERATOR_DELETE(ptr);
}
#endif
...
// hh  000314 Decorated with _EWL_IMP_EXP
// JWW 000413 Changed _EWL_IMP_EXP to _EWL_IMP_EXP_RUNTIME
